...
#define STRING_CONFIG_H_AUTHOR "(Joseph Breihan)" // Who made the changes.
...
#define MANUAL_Z_HOME_POS 0.25 // Distance between the nozzle to printbed after homing
...
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {80,80,4000,1116}  // default steps per unit for Ultimaker
#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,3200/8,161.3}  // default steps per unit for Ultimaker
//#define DEFAULT_AXIS_STEPS_PER_UNIT   {100,100,4000,456}  // default steps per unit for Ultimaker
